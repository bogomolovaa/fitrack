...
public class ModelEntityMapper {
    ...
    public static Track entityToModel(TrackEntity from) {
        ...
        to.setEndPointId(from.getEndPointId());
        to.setEndSmoothedPointId(from.getEndSmoothedPointId());
        to.setEndTime(from.getEndTime());
        to.setStartPointId(from.getStartPointId());
        to.setStartSmoothedPointId(from.getStartSmoothedPointId());
